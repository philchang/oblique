...
(\citealt{paperI}, hereafter ACP12, \citealt{Schlickeiser+12,Schlickeiser+13}), depositing this energy
...
(ACP12;\citealt{Schlickeiser+12,Schlickeiser+13}).
...
\end{equation}
For $k_x = 0$, we recover the same beam-plasma instability which was described in the Appendix of ACP12.  
...
To begin let us return to the reactive instability.  For the growth rate of the reactive instability in Equation (\ref{eq:growth rate reactive}) to be valid, the velocity dispersion must be vanishingly small. Quantitatively, this limit requires
\begin{equation}
