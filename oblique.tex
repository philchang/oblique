...
\end{equation}
We then take the limit of Equation (\ref{eq:distribution function beam}) as $k_BT_t  \rightarrow 0$, which yields a $\delta$ function. For the target plasma, $v_0=0$, and for a beam plasma $v_0=\vbeam$.  This leads to equation (\ref{eq:dispersion relation reactive}), which we reproduce below.  
