...
As the target plasma is nonrelativistic, we can take $v\ll c$ and $\gamma \rightarrow 1$.  Expanding the denominator in powers of $v$, we find\footnote{An alert reader will note that $\gamma$ will contribute to expansion in power of $v$ to second order.  These contributions are the result of the minor deviations from one of the Lorentz factor of the nonrelativistic electrons at order $v^2/c^2$ and effectively corrects the mass of the electron.  We ignore these effects while keeping the $O(v^2/c^2)$ correction from the Langmuir wave because the Lorentz corrections does not depend on the wavevector while the Langmuir corrections do.}
\begin{eqnarray}
